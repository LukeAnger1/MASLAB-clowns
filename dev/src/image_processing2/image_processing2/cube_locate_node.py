...
class CubeLocate(Node):
    ...
    def __init__(self):
        ...
        self.image_sub = self.create_subscription(PixelLocations, "cube_locations/pixel_locations2", self.transform_callback, 1)
        self.cube_image_pub = self.create_publisher(MapLocations, "cube_locations/map_locations2", 1)
