...
class CubeDetect(Node):
    ...
    def __init__(self):
        ...
        self.image_sub = self.create_subscription(CompressedImage, "/image_raw/compressed2", self.image_callback, 1)
        # self.cube_image_pub = self.create_publisher(CompressedImage, "cube_image/compressed", 10)
        self.cube_image_pub = self.create_publisher(PixelLocations, "cube_locations/pixel_locations2", 1)
